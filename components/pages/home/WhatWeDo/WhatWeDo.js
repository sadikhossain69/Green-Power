                ...
                <div className=" container mx-auto py-10">
                    ...
                    <div>
                        <span className="flex justify-center">
                            <h1 className={`text-center text-[#0000FF] lg:text-6xl md:text-3xl text-2xl border-b-2 border-[#52FF00] inline py-2 ${akshar.className}`}>
                        ...
                        <div className="flex md:flex-row flex-col justify-between py-10 px-6 space-y-3 md:space-y-0">
                            <div>
                                <p className={`text-[#0000FF] font-semibold border-b-2 border-[#52FF00] inline text-2xl ${akshar.className}`}>Why Green Powered Systems?</p>
                                <ul>
                            ...
                            <div>
                                <p className={`text-[#0000FF] font-semibold border-b-2 border-[#52FF00] inline text-2xl ${akshar.className}`}>What you get?</p>
                                <ul>
