            ...
            <section className=" container mx-auto py-10">
                ...
                <div>
                    ...
                    <div className="flex md:flex-row flex-col justify-between py-10 px-6 space-y-3 md:space-y-0">
                        <div>
                            <p className="text-[#0000FF] font-semibold border-b-2 border-[#52FF00] inline text-2xl font-[Righteous]">Why Green Powered Systems?</p>
                            <ul>
                        ...
                        <div>
                            <p className="text-[#0000FF] font-semibold border-b-2 border-[#52FF00] inline text-2xl font-[Righteous]">What you get?</p>
                            <ul>
